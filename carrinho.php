            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shoping__cart__btns">
                        <a href="produtos.php" class="primary-btn cart-btn cart-btn-right bg-success text-light"></span>
                ...
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        <h5>Totais</h5>
                        <ul>
                            <li>Subtotal <span>R$ 454,98</span></li>
                            <li>Total <span>R$ 454,98</span></li>
                        </ul>
